<template>
  <div style="margin-top: 20px">
    <el-form :inline="true">
      <el-form-item>
        <el-select v-model="agentBusinessman.status" placeholder="请选择状态">
          <el-option
      ...
      <el-form-item>
        <el-input v-model="agentBusinessman.id" placeholder="代理商编号"  clearable></el-input>
      </el-form-item>


      <el-form-item>
        <el-date-picker
          v-model="agentBusinessman.gmtCreate"
          type="daterange"
          align="right"
          unlink-panels
          range-separator="至"
